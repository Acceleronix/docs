...
<button 
  onClick={() => window.generateAuthParams && window.generateAuthParams()}
  style={{
...
<div id="authResult" style={{ display: 'none' }}>
  ...
  <div style={{ marginBottom: '10px' }}>
    ...
    <button onClick={() => window.copyToClipboard && window.copyToClipboard('usernameResult')} style={{
      fontSize: '12px',
      padding: '4px 8px',
  ...
  <div style={{ marginBottom: '10px' }}>
    ...
    <button onClick={() => window.copyToClipboard && window.copyToClipboard('passwordResult')} style={{
      fontSize: '12px',
      padding: '4px 8px',
      backgroundColor: '#f0f0f0',
      border: '1px solid #ccc',
...
<script dangerouslySetInnerHTML={{
  __html: `
    // Bind functions to global window object to ensure they're accessible
    ...
    window.generateAuthParams = async function() {
      try {
        ...
        const passwordHash = await window.sha256(passwordInput);
    ...
    console.log('Authentication helper functions loaded');
  `
}} />
